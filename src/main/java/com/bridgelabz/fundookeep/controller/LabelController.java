...
public class LabelController {
	...
	public ResponseEntity<Response> createLabel(@RequestBody LabelDTO labelDTO,@RequestHeader(name = "header") String token){
		return ResponseEntity.ok().body(lService.createLabel(token, labelDTO));
	}
	
	@PutMapping(value = "/update")
	public ResponseEntity<Response> updateLabel(@RequestBody LabelDTO labelDTO,@RequestHeader(name = "header") String token, Long lid){
	...
	public ResponseEntity<Response> deleteLabel(@RequestHeader(name = "header") String token,@RequestParam Long lid){
	...
	public ResponseEntity<Response> getAllLabel(@RequestHeader(name = "header") String token){
	...
	public ResponseEntity<Response> getNotesOfLable(@RequestHeader(name = "header") String token,@RequestParam Long lid){
